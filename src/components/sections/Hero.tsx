...
export const Hero = () => {
  ...
  return (
    <section id="home" aria-labelledby="hero-heading" className="min-h-dvh flex flex-col justify-center relative overflow-hidden bg-slate-50 dark:bg-[#050505] pt-24 pb-20 lg:py-28 2xl:py-32 scroll-mt-28 transition-colors duration-300">
        ...
        <div className="space-y-6 sm:space-y-8 flex flex-col items-center">
          <div className="flex flex-col items-center w-full">
            ...
            <motion.h1 
              ...
              className="text-4xl xs:text-5xl sm:text-6xl md:text-7xl lg:text-7xl xl:text-8xl 2xl:text-9xl font-lora font-normal text-slate-900 dark:text-white tracking-normal mb-8 sm:mb-12 lg:mb-16 cursor-default wrap-break-word w-full text-center leading-tight px-2 sm:px-4"
            >
            ...
            {content.hero.intro && (
            <div className="text-lg sm:text-xl md:text-2xl text-slate-600 dark:text-white font-light max-w-3xl mx-auto leading-relaxed transition-colors text-center min-h-16 px-4">
              <Typewriter  
          ...
          >
            <SocialLink href={content.social.linkedin} label="Abrir LinkedIn" className="text-slate-900 dark:text-white hover:text-slate-600 dark:hover:text-[#33ff33] transition-colors transform hover:-translate-y-1">
            ...
            <SocialLink href={content.social.github} label="Abrir GitHub" className="text-slate-900 dark:text-white hover:text-slate-600 dark:hover:text-[#33ff33] transition-colors transform hover:-translate-y-1">
              <svg className="h-9 w-9 md:h-10 md:w-10" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
